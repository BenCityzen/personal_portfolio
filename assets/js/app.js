...
<a class="navbar-brand" href="index.html">Thulani Ben Moloi  </a>
...
<div class="collapse navbar-collapse " id="navbarSupportedContent">
  <ul class="navbar-nav ml-auto" id = "navbar-content">
   ...
   <li class="nav-item nav-item-hover"><a class="nav-link" href="TBMoloi.pdf">Resume</a></li>
  ...
  $(window).scroll(function () {
    ...
    if ($(window).scrollTop() < $(window).height()) {
      ...
      if (
        ...
        $("#btnScrollToTop").css("background-color", "rgb(87, 208, 252)");
      } else {
        $("#btnScrollToTop").css("background-color", "rgb(87, 208, 252)");
      }
    }
